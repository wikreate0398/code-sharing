...
import {
    ...
    Value,
    Description
} from '@/components/screens/dashboard/cashbox/wallet/components'
import { Box } from '@mui/material'
import IconBtn from '@/components/ui/button/icon-button'
import Icon from '@/components/ui/icon'
import React from 'react'
import { useDeleteWalletMutation } from '@/redux/api/cashbox/wallet.api'
import ModalBtn from '@/components/ui/modal/modal-btn'
import WalletStoreModal from '@/components/screens/dashboard/cashbox/wallet/modals/wallet-store-modal'
